...
export class IncidentAlertClient extends ClientBase implements IIncidentAlertClient {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        super();
        this.http = http;
        this.baseUrl = baseUrl !== undefined && baseUrl !== null ? baseUrl : this.getBaseUrl("http://localhost:6359");
    }
...
export class NearMissDto extends BaseDto implements INearMissDto {
    ...
    unsafeActs?: UnsafeActDto[] | undefined;
    divisionId!: number;
    ...
    init(_data?: any) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["unsafeActs"])) {
                this.unsafeActs = [] as any;
                for (let item of _data["unsafeActs"])
                    this.unsafeActs!.push(UnsafeActDto.fromJS(item));
            }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.unsafeActs)) {
            data["unsafeActs"] = [];
            for (let item of this.unsafeActs)
                data["unsafeActs"].push(item.toJSON());
        }
...
export class UnsafeActDto extends BaseDto implements IUnsafeActDto {
    unsafeActId!: number;
    description?: string | undefined;

    constructor(data?: IUnsafeActDto) {
        super(data);
    }
    ...
    init(_data?: any) {
        super.init(_data);
        if (_data) {
            this.unsafeActId = _data["unsafeActId"];
            this.description = _data["description"];
        }
    }

    static fromJS(data: any): UnsafeActDto {
        data = typeof data === 'object' ? data : {};
        let result = new UnsafeActDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["unsafeActId"] = this.unsafeActId;
        data["description"] = this.description;
        super.toJSON(data);
        return data;
    }
...
export interface IUnsafeActDto extends IBaseDto {
    unsafeActId: number;
    description?: string | undefined;
}
